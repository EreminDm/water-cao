<?php /* Smarty version 2.6.26, created on 2015-11-10 18:59:06
         compiled from user/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'user/index.tpl', 20, false),array('function', 'translate', 'user/index.tpl', 20, false),array('function', 'call_hook', 'user/index.tpl', 21, false),array('modifier', 'escape', 'user/index.tpl', 28, false),array('modifier', 'assign', 'user/index.tpl', 183, false),array('modifier', 'date_format', 'user/index.tpl', 239, false),)), $this); ?>
<?php echo ''; ?><?php $this->assign('pageTitle', "user.userHome"); ?><?php echo '<link rel="stylesheet" href="http://water-ca.org/ej/public/journals/1/journalStyleSheet.css" type="text/css"><link rel="stylesheet" href="http://water-ca.org/ej/public/journals/1/usersStyle.css" type="text/css">'; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.manager"), $this);?>
				...
				<td></td>
				<td></td>
				<td align="left"><?php if ($this->_tpl_vars['setupIncomplete'][$this->_tpl_vars['journalId']]): ?>[<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'manager','op' => 'setup','path' => '1'), $this);?>
