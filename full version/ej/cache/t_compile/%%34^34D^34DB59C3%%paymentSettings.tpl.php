<?php /* Smarty version 2.6.26, created on 2015-04-21 12:11:45
         compiled from payments/paymentSettings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'payments/paymentSettings.tpl', 16, false),array('function', 'translate', 'payments/paymentSettings.tpl', 16, false),array('function', 'fieldLabel', 'payments/paymentSettings.tpl', 28, false),array('function', 'form_language_chooser', 'payments/paymentSettings.tpl', 31, false),array('function', 'html_options', 'payments/paymentSettings.tpl', 49, false),array('modifier', 'assign', 'payments/paymentSettings.tpl', 30, false),array('modifier', 'escape', 'payments/paymentSettings.tpl', 67, false),)), $this); ?>
...
<tr>
	<td width="20%"><input type="checkbox" name="purchaseIssueFeeEnabled" id="purchaseIssueFeeEnabled" value="1"<?php if ($this->_tpl_vars['purchaseIssueFeeEnabled']): ?> checked="checked"<?php endif; ?> /></td>
	<td width="80%"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'purchaseIssueFeeEnabled','key' => "manager.payment.options.purchaseIssueFee"), $this);?>
</td>
</tr>
<tr>
...
<table width="100%" class="data">
<tr>
	<td class="value" width="20%"><input type="checkbox" name="acceptGiftSubscriptionPayments" id="acceptGiftSubscriptionPayments" value="1"<?php if ($this->_tpl_vars['acceptGiftSubscriptionPayments']): ?> checked="checked"<?php endif; ?> /></td>
	<td class="label" width="80%"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'acceptGiftSubscriptionPayments','key' => "manager.payment.options.acceptGiftSubscriptionPayments"), $this);?>
</td>
</tr>
</table>
</div>
