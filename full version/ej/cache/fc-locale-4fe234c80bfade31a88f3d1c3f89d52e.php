<?php return array (
  ...
  'plugins.generic.dataverse.settings.dvnUri' => 'Dataverse Network URL',
  'plugins.generic.dataverse.settings.dvnUriDescription' => 'URL of Dataverse Network to which the journal\'s Dataverse belongs',
  'plugins.generic.dataverse.settings.usernameDescription' => 'Username of account to be used to deposit files in Dataverse',
  'plugins.generic.dataverse.settings.passwordDescription' => 'Password for username given above',
  'plugins.generic.dataverse.settings.dvnUriRequired' => 'Dataverse Network URL is required.',
  'plugins.generic.dataverse.settings.dvnUriNotValid' => 'Dataverse Network URL is not valid.',
  'plugins.generic.dataverse.settings.usernameRequired' => 'Please enter a valid username for the specified Dataverse Network.',
  'plugins.generic.dataverse.settings.passwordRequired' => 'Please enter a valid password for the specified Dataverse Network.',
