<?php return array (
  ...
  'plugins.pubIds.urn.manager.settings.urnSuffix.publisherId' => 'Use the "Custom Identifier" for published items as the URN suffix (must be enabled in Setup 4.3). This is the same identifier that will be used for public URLs.',
  'plugins.pubIds.urn.manager.settings.urnSuffix.customIdentifier' => 'Enter an individual URN suffix for each published item independent and different from the "Custom Identifier" mentioned in the previous option. You\'ll find an additional URN input field on each item\'s metadata page.',
