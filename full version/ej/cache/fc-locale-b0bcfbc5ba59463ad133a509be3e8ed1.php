<?php return array (
  ...
  'plugins.pubIds.doi.manager.settings.doiSuffixPublisherId' => 'Use the "Custom Identifier" for published items as the DOI suffix (must be enabled in Setup 4.3). This is the same identifier that will be used for public URLs.',
  'plugins.pubIds.doi.manager.settings.doiSuffixCustomIdentifier' => 'Enter an individual DOI suffix for each published item independent and different from the "Custom Identifier" mentioned in the previous option. You\'ll find an additional DOI input field on each item\'s meta-data page.',
